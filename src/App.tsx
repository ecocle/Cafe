...
function App() {
    ...
    useEffect(() => {
        ...
        if (token) {
            fetch('https://172.16.13.205:5000/api/user_data', {
                headers: {
    ...
    useEffect(() => {
        ...
        fetch('https://172.16.13.205:5000/api/dataCoffee', {
            headers: {
                Authorization: `Bearer ${token}`
            }
        })
    ...
    useEffect(() => {
        ...
        fetch('https://172.16.13.205:5000/api/dataCaffeineFree', {
            headers: {
                Authorization: `Bearer ${token}`
            }
        })
    ...
    useEffect(() => {
        ...
        fetch('https://172.16.13.205:5000/api/dataBreakfast', {
            headers: {
                Authorization: `Bearer ${token}`
            }
        })
